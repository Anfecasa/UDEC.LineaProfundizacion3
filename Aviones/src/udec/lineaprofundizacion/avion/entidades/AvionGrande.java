...
public class AvionGrande extends Avion implements AvionInterface {

	public AvionGrande(String destino, String tipoAvion) {	
	...
	public void imprimir() {
		...
		System.out.println("*                                         ************                                         ******                  *");
		System.out.println("*                      ********************************************************              ********                  *");
		System.out.println("*                  ****** " + super.colorEstadoSilla("A01") + " ** " + super.colorEstadoSilla("A04") + " ***** " + super.colorEstadoSilla("B01") + " ** " + super.colorEstadoSilla("B04") + " ** " + super.colorEstadoSilla("B07") + " ** " + super.colorEstadoSilla("B10") + " **** " + super.colorEstadoSilla("C01") + " *******       **********                  *");
		System.out.println("*               **********************************************************************   *************                 *");
		System.out.println("*             *********** " + super.colorEstadoSilla("A02") + " ** " + super.colorEstadoSilla("A05") + " ***** " + super.colorEstadoSilla("B02") + " ** " + super.colorEstadoSilla("B05") + " ** " + super.colorEstadoSilla("B08") + " ** " + super.colorEstadoSilla("B11") + " **** " + super.colorEstadoSilla("C02") + " **************************                *");
		System.out.println("*               **********************************************************************   *************                 *");
		System.out.println("*                  ****** " + super.colorEstadoSilla("A03") + " ** " + super.colorEstadoSilla("A06") + " ***** " + super.colorEstadoSilla("B03") + " ** " + super.colorEstadoSilla("B06") + " ** " + super.colorEstadoSilla("B09") + " ** " + super.colorEstadoSilla("B12") + " **** " + super.colorEstadoSilla("C03") + " *******       **********                  *");
		System.out.println("*                      ********************************************************              ********                  *");
		System.out.println("*                                         ************                                         ******                  *");
		System.out.println("*                                          **************                                        ****                  *");
		System.out.println("*                                           **************                                         **                  *");
	...
	public void llenarMapSillas() {
		...
		super.getMapSillas().put("C01", FabricaSillas.fabricarSilla(Constantes.SILLA_NEGOCIOS_CLASE));
		super.getMapSillas().put("C02", FabricaSillas.fabricarSilla(Constantes.SILLA_NEGOCIOS_CLASE));
		super.getMapSillas().put("C03", FabricaSillas.fabricarSilla(Constantes.SILLA_NEGOCIOS_CLASE));
